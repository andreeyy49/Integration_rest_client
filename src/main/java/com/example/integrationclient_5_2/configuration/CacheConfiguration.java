package com.example.integrationclient_5_2.configuration;

import com.example.integrationclient_5_2.configuration.properties.AppCacheProperties;
...
public class CacheConfiguration {
    ...
    @Bean
    @ConditionalOnExpression("'${app.cacheType}'.equals('inMemory')")
            ...
            protected Cache createConcurrentMapCache(String name) {
                return new ConcurrentMapCache(
                        ...
                        CacheBuilder.newBuilder()
                                .expireAfterWrite(appCacheProperties.getCaches().get(name).getExpire())
                                .build()
                                .asMap(),
                        true
                );
    ...
    @ConditionalOnExpression("'${app.cacheType}'.equals('redis')")
